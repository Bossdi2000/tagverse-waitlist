...
const FollowButton = styled(Button)(({ theme, completed }) => ({
  ...
  [theme.breakpoints.down("sm")]: {
    height: "36px", // Further reduced for inline layout
    padding: "0 12px", // Reduced padding
    fontSize: "0.75rem", // Smaller font
    maxWidth: "100px", // Tighter max width
  },
}))
      ...
      <ContentContainer>
        <Box textAlign="center">
          ...
          <AnimatedBox visible={isVisible} delay={500}>
            ...
            <Box
              display="flex"
              flexDirection="row" // Inline on all screens
              flexWrap="wrap" // Allow wrapping if needed
              justifyContent="center"
              alignItems="center"
              gap={{ xs: 1, sm: 2 }} // Smaller gap on xs
              mb={4}
              sx={{ 
                width: { xs: "100%", sm: "auto" }, // Ensure full width on small screens
                px: { xs: 1, sm: 0 }, // Padding to prevent edge clipping
              }}
            >
              <FollowButton
                component={Link}
